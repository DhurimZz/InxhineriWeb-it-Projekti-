    ...
    <div class="headconteiner">
        <div class="colorcontainer1">
            <div class="conteinerwrapper">
                <div class="FirstPicture1"></div>
                <div class="SecondPicture2"></div>

                <div class="TextofAboutUs">
                    <p class="TestAboutUsColor1">Rreth Nesh</p>
                    <p class="TestAboutUsColor2">Nga fillimi në fund, faqja ShëndetiIM qëndron si faqe informuese rreth
                        shëndetit dhe lajmeve nga shëndeti. Për më tepër, faqja ShëndetiIM mund te konsiderohet edhe si
                        faqe edukuese rreth mirëqenies shëndetësore.<br>
